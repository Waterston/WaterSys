...
module.exports = {
    ...
    run: async (client, message, args) => {
        let g = args[0]
	if (message.author.id !== '137663615657312256' || '566044959090802690') return message.reply(":no_entry: Insufficient permissions. This incident will be reported.").then(r => r.delete({timeout: 10000})).then(g => console.log(`${message.author.tag} attempted to issue forceleave unsucessfully.`)) .catch(console.error);
