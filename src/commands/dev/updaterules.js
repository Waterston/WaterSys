...
module.exports = {
    ...
    .setColor("#0084ff")
		...
		{ name: '1.5: Profanity', value: `Cursing is allowed but limited to low use. Any use of racist, sexist, slurs, or other insulting curse words is not allowed and can result in an immediate ban.`, inline: false },
