...
module.exports = {
    ...
    .setColor("#00a2cb")
		...
		{ name: '1.8: Member Privacy', value: `Do not expose any personal information without that person's permission. Please respect each members' privacy balance from in real life and Roblox/Discord. This also includes posting unfamiliar links/location (IP grabbers or cookie loggers).`, inline: false },
		{ name: '1.9: Advertising', value: `Advertising is strictly forbidden. This includes Roblox groups, Discord servers, etc. Do not send unsolicited messages to people, as that is prohibited.`, inline: false },
    ...
    .setColor("#bc9378")
        .addFields(
		{ name: '3.1: Discord Moderator', value: `Community Managers have final say on deeming what your punishment is based on what rule(s) were broken. Do not publicly make a dispute with your punishment or you will be muted.`, inline: false },
		{ name: '3.2: Warnings/Kicks Limit', value: `When you receive three (3) warnings, you will be kicked from the Vena Studios server. If you receive another three (3) warnings when you return, you will be banned. Appealed warnings/kicked will be removed and not counted towards your next moderation action.`, inline: false },
		...
		{ name: '3.5: Common Sense', value: `Please use common sense and basic knowledge when conducting yourself. Do not do anything that you know will get you punished. Additionally, do not try to exploit loopholes in the rules as it will apply to any situations.`, inline: false },
		...
		{ name: '3.7: Waterston Founders', value: `Vena Studios founders shall be known as Bandelqs, Pearism, and JaimieKoch. They are above all rules listed above. **Please refrain from tagging without a plausible reason** and use the chain of command system.`, inline: false },
		{ name: '3.8: Discord Term of Services & Community Guidelines', value: `We are required to ensure that this server follows the [Terms of Service](https://discord.com/terms) and [Community Guidelines](https://discord.com/guidelines) set by Discord (linked for your convenience). We are also legally required to remove any user that is under the age of thirteen (13) years old. It is recommended that you avoid discussing or joking about your ages, as there is no exceptions in the Terms of Service.`, inline: false }
